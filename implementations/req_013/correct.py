...
# Tarifas base por regiao (regioes nao listadas usam a base padrao).
_BASE_BY_REGION = {
    "sul": Decimal("10.0"),
...
_WEIGHT_THRESHOLD = Decimal("5")     # peso isento de adicional (fechado)
_PER_KG = Decimal("2.0")             # adicional por kg excedente
_EXPRESS_FACTOR = Decimal("1.5")     # +50% na modalidade expressa
...
def shipping_cost(weight: float, region: str, express: bool) -> float:
    ...
    # Adicional proporcional ao peso acima de 5 kg.
