# Fault: guarda ausente (falta o tratamento de weight <= 0).
# Sem a guarda, peso invalido (<= 0) nao retorna 0.0: aplica a base da regiao
# (e ate subtrai adicional negativo), violando o invariante de entrada invalida.
...
def shipping_cost(weight: float, region: str, express: bool) -> float:
    ...
    # DEFEITO: falta a guarda "if w <= 0: return 0.0"
