# Fault: fronteira/off-by-one no limite de peso (excess = w - 4 em vez de w - 5).
# Cobra adicional ja a partir de pesos acima de 4 kg (fronteira deslocada).
...
_WEIGHT_THRESHOLD = Decimal("4")     # DEFEITO: deveria ser 5
_PER_KG = Decimal("2.0")
