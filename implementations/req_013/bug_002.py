# Fault: operador errado (adicional de peso somado por '*' vira '+' na composicao).
# O adicional de peso e' SUBTRAIDO da base em vez de somado.
...
def shipping_cost(weight: float, region: str, express: bool) -> float:
    ...
    if excess > 0:
        base -= excess * _PER_KG  # DEFEITO: deveria ser base +=
