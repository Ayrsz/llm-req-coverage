...
- [x] T14 — docs: tabela "Requisitos atuais" (N=15, com coluna **classe**) no CLAUDE.md (era N=3) e **nova** no README; N atualizado nas limitações de ambos; corrigida a afirmação obsoleta de saturação da mutação (Fase 3 confirmou discriminação). **Fase 3 COMPLETA (T01–T14, DoD1–DoD7).**
